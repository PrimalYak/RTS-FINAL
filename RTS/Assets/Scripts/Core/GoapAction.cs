...
namespace SwordGC.AI.Goap
{
    public class GoapAction
    {
        ...
        public class Effects
        {
            ...
            public const string HAS_SUFFICIENT_GOLD_WARRIOR  = "HasSufficientGoldWarrior";
            public const string HAS_SUFFICIENT_GOLD_ARCHER   = "HasSufficientGoldArcher";
            public const string HAS_SUFFICIENT_GOLD_MAGE     = "HasSufficientGoldMage";
            public const string HAS_SUFFICIENT_GOLD_GATHERER = "HasSufficientGoldGatherer";
